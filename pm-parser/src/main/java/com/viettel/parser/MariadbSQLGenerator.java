...
//
//import static com.viettel.betterversion2.parser.CommonDataBuilder.*;
//import static com.viettel.betterversion2.parser.SqlGenerationConfig.*;
//
//@Slf4j
//public class MariadbSQLGenerator implements SQLGenerator{
//    @Override
...
//                            .append(CommonDataBuilder.getDateRoundMySQL(inputData.getInterval(),
...
//            String sDuration = calculateDuration(inputData);
//
...
//                        timeRangeSQL = getStringBuilderTimeRange(inputData);
//                    }
//
//                    // Build SQL
//                    try {
...
//
//        } catch (Exception e) {
//            log.error("Error building Mariadb SQL", e);
//        }
//
//        return lstQueryObjects;
//
